...
import com.fastcampus.userservice.exception.InvalidTokenException
...
class UserService(
    ...
    suspend fun getByToken(token: String): User {
        val cachedUser = cacheManager.awaitGetOrPut(key = token, ttl = CACHE_TTL) {
            ...
            val userId: Long = decodedJWT.claims["userId"]?.asLong()?: throw InvalidTokenException()
